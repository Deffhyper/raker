...
<div class="container">
    <div class="row">
        <div class="col-12">
            <h1 class="lk-title lk-title--big text-lg-right">Мой профиль</h1>
        </div>
    </div>
</div>
                            ...
                            <div class="lk-user-form__wrapper">
                                ...
                                <fieldset class="input-block">
                                    ...
                                    <div class="input-date">
                                        ...
                                        <svg class="custom-date-icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="20" height="20"
                                             viewBox="0 0 20 20">
                                            <image id="small-calendar" width="20" height="20"
                                                   xlink:href="data:img/png;base64,"></image>
                                        </svg>
                                    </div>
                                </fieldset>
                            </div>
