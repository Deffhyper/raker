    ...
    <ul class="block-list">
        <li class="block-list__item">
            <div class="goods-hrz">
                <div class="goods-hrz__back">
                    <img src="img/jpeg_files/goods-h-1.jpg" alt="alter" width="" height="">
                </div>
        ...
        <li class="block-list__item">
            <div class="goods-hrz goods-hrz--inverse">
                <div class="goods-hrz__back">
                    <img src="img/jpeg_files/goods-h-2.jpg" alt="alter" width="" height="">
                </div>
                <div class="goods-hrz__right">
                    <div class="goods-hrz-title">
                        <a href="#" class="goods-hrz-title__link">Улов из Греции в две строки</a>
                    ...
                    <ul class="list-inline goods-hrz-icons">
                        ...
                        <li class="goods-hrz-icons__item">
                            <a href="javascript:void(0);" role="button" class="icon-tooltip-trigger">
                                <span class="iconmoon icon-fish-3"></span>
                            </a>
                            <div class="icon-tooltip">
                                <a href="javascript:void(0);" role="button" class="icon-tooltip__close"></a>
                                <div class="icon-tooltip__img">
        ...
        <li class="block-list__item">
            <div class="goods-hrz">
                <div class="goods-hrz__back">
                    <img src="img/jpeg_files/goods-h-3.jpg" alt="alter" width="" height="">
                </div>
                <div class="goods-hrz__right">
                    <div class="goods-hrz-title">
                        <a href="#" class="goods-hrz-title__link">Улов из Греции в две строки</a>
        ...
        <li class="block-list__item">
            <div class="goods-hrz">
                <div class="goods-hrz__back">
                    <img src="img/jpeg_files/goods-h-4.jpg" alt="alter" width="" height="">
                </div>
                <div class="goods-hrz__right">
                    <div class="goods-hrz-title">
                        <a href="#" class="goods-hrz-title__link">Улов из Греции в две строки</a>
        ...
        <li class="block-list__item">
            <div class="goods-hrz">
                <div class="goods-hrz__back">
                    <img src="img/jpeg_files/goods-h-5.jpg" alt="alter" width="" height="">
                </div>
                <div class="goods-hrz__right">
                    <div class="goods-hrz-title">
                        <a href="#" class="goods-hrz-title__link">Улов из Греции в две строки</a>
...
<section class="container slider-section">
    <h3 class="slider-title">Fresh Catch дня</h3>
...
<section class="main-shares"
         style="background: #f7f7f7 url('img/jpeg_files/big-banner.jpg') no-repeat center / cover">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-12">
                <h3 class="main-shares__title">Fresh Catch <br> всего в пару кликов</h3>
                <p class="main-shares__subtitle">Скачай приложение на свой смартфон , <br> заказуй свежую рыбу не выходя
                    из дома</p>
